...
const val defaultRange = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-_"
...
fun Random.nextString(length: Int = 7, range: String = defaultRange): String {
